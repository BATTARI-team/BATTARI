    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: FlutterMap(
              options: MapOptions(initialCenter: LatLng(widget.latitude, widget.longitude),),
              children: [
                TileLayer(
                ...
                MarkerLayer(
                  markers: [
                    Marker(
                      width: 80.0,
                      height: 80.0,
                      point: LatLng(widget.latitude, widget.longitude), child: const Icon(Icons.home),
                    ),
                  ],
                ),
              ],
          ...
          if (widget.latitude != 0 && widget.longitude != 0) 
            Consumer(
              builder: (context, ref, _) {
                return TextButton(child: const Text("続ける"), onPressed: () {
