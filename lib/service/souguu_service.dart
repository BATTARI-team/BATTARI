...
class SouguuService extends _$SouguuService {
  ...
  Future<void> _refreshToken() async {
    ...
    try {
      await http
          .post(Uri.parse('http://$endPoint:5050/User/RefreshToken'),
  ...
  void disconnectWebsocket() async {
    ...
    await http.get(Uri.parse('http://$endPoint/SouguuInfo/ClearSouguuIncredient'), headers: <String, String>{
...
class SouguuServiceInfo extends _$SouguuServiceInfo {
  ...
  Future<bool> init() async {
    ...
    try {
      var result = await http.get(Uri.parse('http://$endPoint/SouguuInfo/GetSouguuInfo'), headers: <String, String>{
        'Authorization': 'Bearer $Token',
      });
